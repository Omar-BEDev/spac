## Overview
Welcome to the Spak project! We are pleased that you wish to help us with the project by contributing.
We welcome any assistance that will grow the project.
Below is some information on how to contribute.

## Code writing requirements
1 - Use a `gofmt` tool to format the code.<br>
...
8 - The branch designated for submitting pull requests is `dev`the one where any withdrawal request for another branch will be rejected<br>
